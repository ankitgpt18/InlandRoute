...
export interface RiverPort {
  ...
  lng: number;
  km: number;
  type: 'Multimodal Terminal' | 'Inland Port' | 'Lock Gate' | 'Jetty';
  capacityDWT: number;
  status: 'Operational' | 'High Tide Only' | 'Dredging in Progress';
}

export interface CWCGaugeStation {
  id: string;
  name: string;
  waterwayId: WaterwayId;
  lat: number;
  lng: number;
  waterLevelM: number;
  dischargeCumech: number;
  trend: 'Rising' | 'Falling' | 'Stable';
}

export const NW1_PORTS: RiverPort[] = [
  { id: 'port-vns', name: 'Varanasi Multimodal Terminal', waterwayId: 'NW-1', lat: 25.3176, lng: 83.0062, km: 0, type: 'Multimodal Terminal', capacityDWT: 2000, status: 'Operational' },
  { id: 'port-bgp', name: 'Bhagalpur Inland Port', waterwayId: 'NW-1', lat: 25.2425, lng: 87.0139, km: 520, type: 'Inland Port', capacityDWT: 1500, status: 'Operational' },
  { id: 'port-shb', name: 'Sahibganj Multimodal Terminal', waterwayId: 'NW-1', lat: 25.2504, lng: 87.6477, km: 650, type: 'Multimodal Terminal', capacityDWT: 2000, status: 'Operational' },
  { id: 'port-frk', name: 'Farakka Lock Gate & Terminal', waterwayId: 'NW-1', lat: 24.8143, lng: 87.9304, km: 800, type: 'Lock Gate', capacityDWT: 1500, status: 'Dredging in Progress' },
  { id: 'port-ccu', name: 'Kolkata GRJ Jetty', waterwayId: 'NW-1', lat: 22.5726, lng: 88.3639, km: 1350, type: 'Jetty', capacityDWT: 1800, status: 'Operational' },
  { id: 'port-hld', name: 'Haldia Floating Terminal', waterwayId: 'NW-1', lat: 22.0257, lng: 88.0583, km: 1540, type: 'Multimodal Terminal', capacityDWT: 3000, status: 'Operational' },
];

export const NW2_PORTS: RiverPort[] = [
  { id: 'port-dhb', name: 'Dhubri Inland Port', waterwayId: 'NW-2', lat: 26.0203, lng: 89.9744, km: 0, type: 'Inland Port', capacityDWT: 1500, status: 'Operational' },
  { id: 'port-pnd', name: 'Pandu (Guwahati) Multimodal Terminal', waterwayId: 'NW-2', lat: 26.1667, lng: 91.7000, km: 260, type: 'Multimodal Terminal', capacityDWT: 2000, status: 'Operational' },
  { id: 'port-tzp', name: 'Tezpur Inland Terminal', waterwayId: 'NW-2', lat: 26.6338, lng: 92.7926, km: 430, type: 'Inland Port', capacityDWT: 1200, status: 'Operational' },
  { id: 'port-nmt', name: 'Neamati Ghat Jetty', waterwayId: 'NW-2', lat: 26.8500, lng: 94.2167, km: 620, type: 'Jetty', capacityDWT: 1000, status: 'Operational' },
